...
Class Mobile{
    ...
    public function trashed(){
        ...
        if(mysql_query($query)){
            $_SESSION['message'] = "Your data temporary deleted.";
        }else{
            $_SESSION['message'] = "Opps! Here some problems.";
        }
    ...
    public function restore(){
        ...
        if(mysql_query($query)){
            $_SESSION['message'] = "Well done! successfully restore your data.";
        }else{
            $_SESSION['message'] = "Opps! Here some problems.";
        }
    ...
    public function delete(){
        ...
        if(mysql_query($query)){
            $_SESSION['message'] = "Parmanently delete your data.";
        }else{
            $_SESSION['message'] = "Opps! Here some problems.";
        }
        header('location:trash.php');
    ...
    public function update(){
        ...
        if(mysql_query($query)){
            $_SESSION['message'] = "Well done! successfully updated your data.";
        }else{
            $_SESSION['message'] = "Opps! Here some problems.";
        }
        header('location:index.php');
