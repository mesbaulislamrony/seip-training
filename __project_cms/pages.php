			...
			<div class="col-sm-8">
				...
				<div class="post-content">
					<div class="page-header">
						<h4><a href="single.php?id=<?php echo $menu['article_id'] ?>"><?php echo $menu['title'] ?></a></h4>
						<p>Published on : <?php $date = date_create($menu['created_at']); echo date_format($date, 'M-d-Y');?></p>
					</div>
					<div class="content">
						<?php echo $menu['html_details'] ?>
					</div>
				</div>
				<?php
					}
